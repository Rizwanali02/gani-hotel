      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden items-center gap-6 md:flex">
            <Link href="/#rooms-section" className="text-sm text-gray-300 hover:text-white">Rooms</Link>
            <Link href="/#menu-section" className="text-sm text-gray-300 hover:text-white">Menu</Link>
        ...
        {isOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 space-y-4">
              <Link href="/#rooms-section" className="block py-2 text-sm text-gray-300" onClick={() => setIsOpen(false)}>Rooms</Link>
              <Link href="/#menu-section" className="block py-2 text-sm text-gray-300" onClick={() => setIsOpen(false)}>Menu</Link>
              ...
              {!loading && user ? (
                <>
                  ...
                  <Button variant="ghost" className="w-full text-gray-400" onClick={() => { signOut(); setIsOpen(false) }}>
                    <LogOut className="mr-2 h-4 w-4" /> Sign Out
                  </Button>
                </>
              ) : (
