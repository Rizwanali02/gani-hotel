...
export function CheckOutButton({
  ...
  return (
    <>
      ...
      {/* Settlement Modal using Radix Portal to prevent clipping */}
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent 
          showCloseButton={false}
          className="w-full max-w-md rounded-2xl border border-gray-800 bg-gray-900 p-0 text-white shadow-2xl overflow-hidden sm:max-w-md"
        >
          {/* Modal Header */}
          <div className="flex items-center justify-between border-b border-gray-800 px-6 py-4">
            <div className="flex items-center gap-2">
              ...
              <DialogTitle className="text-lg font-semibold text-white">Payment Settlement</DialogTitle>
            </div>
            <button
